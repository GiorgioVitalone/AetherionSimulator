...
async function runVerify(flags, { kindOverride } = {}) {
  ...
  const KNOBS = ['GPP_MATRIX', 'RL_GPP', 'RH_GPP', 'RX_GPP', 'SKIP_ROLLOUT', 'FOCUS', 'RESOURCE_DECK', 'AETHERION_CARDS', 'WORKERS', 'HEUR_RAMP', 'RULE_OFF', 'COMP', 'CAND_GEN', 'SEED_MODE', 'ROLLOUT_MAXC'];
