...
export const MOCK_CARDS: SimCard[] = [
  ...
  ...createCharacters('Onyx', 100, [
    ...
    { name: 'Crypt Ghoul', rarity: 'Common', cost: 2, hp: 3, atk: 2, arm: 0 },
    { name: 'Nightshade Acolyte', rarity: 'Common', cost: 2, hp: 3, atk: 1, arm: 1 },
    { name: 'Carrion Guard', rarity: 'Common', cost: 3, hp: 4, atk: 2, arm: 1 },
    { name: 'Tomb Watcher', rarity: 'Common', cost: 4, hp: 5, atk: 3, arm: 1 },
  ...
  ...createCharacters('Radiant', 300, [
    ...
    { name: 'Sunlit Sentry', rarity: 'Common', cost: 2, hp: 3, atk: 2, arm: 1 },
    { name: 'Halo Bearer', rarity: 'Common', cost: 2, hp: 2, atk: 2, arm: 1 },
    { name: 'Mercy Templar', rarity: 'Common', cost: 3, hp: 4, atk: 2, arm: 2 },
    { name: 'Aegis Pilgrim', rarity: 'Common', cost: 4, hp: 5, atk: 3, arm: 2 },
