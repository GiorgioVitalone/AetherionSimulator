...
| RD-15 | Transformation | Strategy timing; once per game; requires the three printed predicates; Ultimate is unavailable on the transform turn | Rulebook §8 transformation and §9 Ultimate | Rules owner | Ratified | WP-02, WP-11 |
